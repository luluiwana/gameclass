...
<div class="container py-4">
    ...
    <div class="row">
        <div class="col-md-9 mt-3">
            <p class="fw-bold text-white small m-2 text-uppercase"> <i class="fas fa-dot-circle text-warning me-1"></i>
            ...
            if (!empty($question)) {
                    ...
                    <div class="card mb-2">
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="btn-group btn-group-sm mt-3" role="group" aria-label="Basic outlined example">
                                <a href="<?= base_url('guru/edit_question/' . $courseID . '/' . $row['EssayID']) ?>" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#edit<?= $row['EssayID'] ?>"> <i class="fas fa-edit"></i>
                                    Edit</a>
                                <a href="<?= base_url('guru/hapus_tugas/' . $courseID . '/'  . $id . '/' . $row['EssayID']) ?>" class="btn btn-outline-warning rounded-end"><i class="fas fa-trash"></i>
                                    Hapus</a>
                                <div class="modal" id="edit<?= $row['EssayID'] ?>" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <span class="text-white fw-bolder">Edit Tugas</span>
                                                ...
                                                <form action="<?= base_url('guru/edit_submission/' . $courseID . '/' . $row['EssayID']) ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <textarea name="soal" class="form-control  text-white" rows="5" required><?= $row['Question'] ?></textarea>
                                                    </div>
                ...
                <div class="card ">
                    <div class="card-body ">
                        ...
                        <hr>
                        <a data-bs-toggle="modal" data-bs-target="#addMateri" class="btn btn-warning" href="<?= base_url('guru/create_question/' . $courseID . '/' . $id) ?>"><i class="fas fa-plus"></i> Buat Pertanyaan</a>
                    </div>
                </div>
            <?php
            } ?>
        ...
        <?php if (!empty($question)) : ?>
            <div class="col-md-3 mt-3 ">
                <div class="card card-body bg-darkgreen">
                    ...
                    <p class="text-white small">Siswa telah mengumpulkan <span class="text-lowercase"><?= $type ?></span></p>
                    <a href="<?= base_url() ?>guru/resultquiz/<?= $course->CourseID ?>/<?= $quiz->QuizID ?>" class="btn btn-warning mt-3"><i class="fas fa-file-alt me-2"></i> Lihat Hasil</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="modal fade" id="addMateri" tabindex="-1" aria-labelledby="addMateriLabel" aria-hidden="true" style="">
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                <div class="modal-body">
                    <span class="text-white fw-bolder">Buat Tugas</span>
                    <button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
                    <hr>
                    <form action="<?= base_url('guru/create_submission/' . $courseID . '/' . $id) ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                <label for="inputCity" class=""></label>
                                <input type="submit" name="processed" value="Buat Tugas" class="form-control btn btn-primary mt-2" id="inputCity">
                            </div>
                        </div>
                    </form>
                </div>
